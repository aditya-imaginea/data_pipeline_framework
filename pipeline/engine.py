...
def run_pipeline(pipeline_path: str, dataset_path: str, state_table_path: str):
    ...
    results = executor.execute(dataset)
...
if __name__ == "__main__":
    ...
    run_pipeline(pipeline_path, dataset_path, output_path)
